...
# DVE full session
# Saved on Thu Jul 2 07:39:07 2020
# Designs open: 1
...
gui_show_window -window ${CovTopLevel.1} -show_state maximized -rect {{3 52} {1918 902}}
...
set CovHier.1 [gui_create_window -type CovHier -parent ${CovTopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 175]
gui_set_window_pref_key -window ${CovHier.1} -key dock_width -value_type integer -value 175
...
gui_update_layout -id ${CovHier.1} {{left 0} {top 0} {width 174} {height 591} {dock_state left} {dock_on_new_line true} {child_covhier_colhier 126} {child_covhier_coltype 39} {child_covhier_col1 1} {child_covhier_col2 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1915} {height 179} {dock_state bottom} {dock_on_new_line true}}
...
catch {gui_list_expand -id ${CovHier.1} soc_top}
catch {gui_list_expand -id ${CovHier.1} soc_top}
...
gui_open_source -id ${CovDetail.1}  -matrix Line -replace -active lfsr_5bit -type {Module}  /home/disk/uvm_diag/generated_tb/sim/../dut/lfsr5.sv
...
gui_covdetail_select -id CovDetail.1 -region {lfsr_5bit} -type {Module}
...
gui_covmap_show -id CoverageMap.1 -show {Modules} -test MergedTest
gui_covmap_show -id CoverageMap.1 -metric {Line}
